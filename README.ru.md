...
Установщик — на странице [последнего релиза](../../releases/latest): `SqwizzeySwitch-Setup-1.2.0.exe`. Прав администратора не требует; приложение самодостаточно (.NET ставить не нужно).
