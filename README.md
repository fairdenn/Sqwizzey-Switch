...
Grab the installer from the [latest release](../../releases/latest) — `SqwizzeySwitch-Setup-1.3.0.exe`. No administrator rights required; the app is self-contained (no .NET install needed).
