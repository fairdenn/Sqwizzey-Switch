...
public static class Loc
{
    ...
    private static readonly Dictionary<string, string[]> D = new()
    {
        ...
        ["animations"]   = new[]{"Card animation (spring)",      "Анимация карточки (пружина)",         "Анімація картки (пружина)",           "Animación de la tarjeta (resorte)","Kartenanimation (Feder)",              "Animation de la carte (ressort)",       "卡片动画（弹簧）",        "Animação do cartão (mola)"},
        ["scrambleLetters"]= new[]{"Scramble letters",           "Скрэмбл букв",                        "Скрембл літер",                       "Mezclar letras",                   "Buchstaben-Scramble",                  "Brouillage des lettres",                "字母乱码效果",            "Embaralhar letras"},
