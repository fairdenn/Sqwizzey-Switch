...
public static class Loc
{
    ...
    private static readonly Dictionary<string, string[]> D = new()
    {
        ...
        ["themeNote"]    = new[]{
            "Theme applies to Frosted, Minimal and Small Rounded. Accent and Neon have a fixed look.",
            "Тема влияет на Frosted, Minimal и Small Rounded. Accent и Neon имеют фиксированный вид.",
            "Тема впливає на Frosted, Minimal і Small Rounded. Accent і Neon мають фіксований вигляд.",
            "El tema se aplica a Frosted, Minimal y Small Rounded. Accent y Neon tienen un aspecto fijo.",
            "Das Design gilt für Frosted, Minimal und Small Rounded. Accent und Neon haben ein festes Aussehen.",
            "Le thème s'applique à Frosted, Minimal et Small Rounded. Accent et Neon ont un aspect fixe.",
            "主题适用于 Frosted、Minimal 和 Small Rounded；Accent 和 Neon 外观固定。",
            "O tema se aplica a Frosted, Minimal e Small Rounded. Accent e Neon têm aparência fixa."},
